...
class check16_00 extends StatefulWidget {
  const check16_00({Key? key}) : super(key: key);

  @override
  _check16_00State createState() => _check16_00State();
}

class _check16_00State extends State<check16_00> {
  var items = [
    lotterry(
      date: 13,
      id: 1,
  ...
  var lott = [578171,285,361,379,449,83];

...
class check1_99 extends StatefulWidget {
  const check1_99({Key? key}) : super(key: key);

  @override
  _check1_99State createState() => _check1_99State();
}

class _check1_99State extends State<check1_99> {
  var items = [
    lotterry(
      date: 13,
      id: 1,
  ...
  var lott = [114475,278,302,123,458,79];

...
class check1_10 extends StatefulWidget {
  const check1_10({Key? key}) : super(key: key);

  @override
  _check1_10State createState() => _check1_10State();
}

class _check1_10State extends State<check1_10> {
  var items = [
    lotterry(
      date: 13,
      id: 1,
  ...
  var lott = [045037,247,458,331,755,95];

...
class check16_10 extends StatefulWidget {
  const check16_10({Key? key}) : super(key: key);

  @override
  _check16_10State createState() => _check16_10State();
}

class _check16_10State extends State<check16_10> {
  var items = [
    lotterry(
      date: 13,
      id: 1,
  ...
  var lott = [386372,964,602,295,798,38];
